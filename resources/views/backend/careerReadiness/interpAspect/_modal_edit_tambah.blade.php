            ...
            <div class="modal-body">
                ...
                <table cellpadding="10" width="100%" class="tabel-form-input">
                        ...
                        <td>
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <select class="form-select" id="input_option_aspect_id">
                                    </select>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr class="border-bottom">
                        ...
                        <td>
                            <div class="form-group">
                                <input class="form-control" type="text" id="aspect_status" name="aspect_status" required>
                            </div>
                        </td>
                    </tr>
                    <tr class="border-bottom">
                        <th>Aspek Interpretasi</th>
                        <td>
                            <div class="form-group">
                                <textarea class="form-control" name="aspect_interpretation" id="aspect_interpretation" required></textarea>
                            </div>
                        </td>
                    </tr>
                    <tr class="border-bottom">
