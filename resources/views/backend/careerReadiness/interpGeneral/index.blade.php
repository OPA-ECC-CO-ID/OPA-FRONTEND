        ...
        <div class="container-fluid pb-4">
            <div class="card">
                <div class="card-header pb-0 px-3">
                    <h6 class="mb-0">Data Interpretasi Umum</h6>
                </div>
            ...
            @include('backend.careerReadiness.interpGeneral._modal_edit_tambah')
            @include('backend.careerReadiness.interpGeneral._modal_show')
        </div>
    </div>
@endsection
