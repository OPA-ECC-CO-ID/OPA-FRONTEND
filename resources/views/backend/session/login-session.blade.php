@extends('backend.layouts.user_type.guest')
                                    ...
                                    <form role="form" id="login">
                                        ...
                                        <div class="mb-3">
                                            <input type="text" class="form-control" name="username_or_email"
                                                id="email" placeholder="Email" value="admin@softui.com"
                        ...
                        <div class="col-md-6">
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6"
                                    style="background-image:url('{{ Vite::asset('resources/img/backend/curved-images/curved6.jpg') }}')">
                                </div>
                            </div>
                        </div>
                    </div>
