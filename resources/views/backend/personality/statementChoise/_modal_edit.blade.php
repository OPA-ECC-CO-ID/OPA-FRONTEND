            ...
            <div class="modal-body">
                ...
                <table cellpadding="10" width="100%" class="tabel-form-input">
                    ...
                    <tr class="border-bottom">
                        ...
                        <td>
                            <div class="form-group">
                                <input class="form-control" type="number" id="page_no" name="page_no" required>
                            </div>
                        </td>
                    </tr>
                    <tr class="border-bottom">
                        ...
                        <td>
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <select class="form-select" id="input_option_cat_id">
                                    </select>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <textarea class="form-control" name="statement" id="statement" rows="4" required></textarea>
                            </div>
                        </td>
                    </tr>
                </table>
