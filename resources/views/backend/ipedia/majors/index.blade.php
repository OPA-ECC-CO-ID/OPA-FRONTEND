            ...
            <div class="container-fluid pb-4">
                <div class="card">
                    <div class="card-header pb-0 px-3">
                        <h6 class="mb-3 section-title">Prodi</h6>
                        <div class="row">
                            <div class="col ">
                                <button type="button" class="btn bg-gradient-primary" id="btn-show-majors">Data
                                    Prodi</button>
                                <button type="button" class="btn" id="btn-show-trash-majors">Tong
                                    Sampah</button>
                            </div>
                    ...
                    <div class="card-body pt-4 p-3" id="interp-category" style="overflow-x:scroll;">
                        ...
                        <div id="data_trash_majors" style="display: none">
                    ...
                    @include('backend.ipedia.majors._modal_edit_tambah')
                </div>
            </div>
        @endsection
