...
@section('content')
    ...
    <div class="container">
        <div class="text-head">
            ...
            <a href="{{ route('icareer') }}" class="custom-link active" id="career-interest-link">Minat Karir</a>
        </div>
    </div>
    <hr>
            ...
            <div class="col-12 col-lg-7 d-flex align-items-center">
                <div class="intruksi-text-content mx-auto">
                    ...
                    <div class="btn-group-ass">
                        <a href="{{ route('icareer.test') }}" class="btn btn-custom next" id="btn-kerjakan">Kerjakan</a>
                        <a href="{{ route('icareer.sk') }}" class="btn btn-outline-back">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
