        ...
        <div class="sk-text-content mx-auto">
          <h2>Syarat dan Ketentuan</h2>
              ...
              <div class="btn-group-ass">
                <a href="{{route('CareerReadiness.instruction')}}" class="btn btn-custom next">Lanjutkan</a>
                <a href="{{route('CareerReadiness.attention')}}" class="btn btn-outline-back">Kembali</a>
              </div>
        </div>
      </div>
    </div>
