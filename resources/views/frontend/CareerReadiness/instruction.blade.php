                ...
                <div class="col-12 col-lg-7 d-flex align-items-center">
                    <div class="intruksi-text-content mx-auto">
                        ...
                        <ol class="">
                            ...
                            <li>Pastikan pilihan Kamu sesuai dengan minat atau ketertarikan Kamu terhadap isi dari
                                pernyataan
                                tersebut.</li>
                        ...
                        <div class="btn-group-ass">
                            <a href="{{ route('CareerReadiness.test') }}" class="btn btn-custom next"
                                id="btn-kerjakan">Kerjakan</a>
                            <a href="{{ route('CareerReadiness.sk') }}" class="btn btn-outline-back">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
