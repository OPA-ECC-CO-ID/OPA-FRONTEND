...
$(document).ready(function () {
    $("#myTable").DataTable({
        ...
        serverside: true,
        ajax: {
            url: API_URL + "/api/v1/ipedia/education-type?limit=-1",
            type: "GET",
            dataSrc: "data.data",
            timeout: 5000,
    ...
    $("#myTrashTable").DataTable({
        ...
        serverside: true,
        ajax: {
            url: API_URL + "/api/v1/ipedia/education-type/deleted?limit=-1",
            type: "GET",
            dataSrc: "data.data",
            timeout: 5000,
            error: function (xhr, status, error) {
        ...
        columns: [
            ...
            },
            {
                render: function (data, type, full, meta) {
                    ...
                    return `
                    <div class="action-table">
                        <button class="badge bg-gradient-info tombol-restore" data-id="${id}" data-bs-toggle="modal" data-bs-target="#editModal"><i class="fa fa-undo" aria-hidden="true"></i></button>
...
$("body").on("click", "#btn-show-trash-education", function () {
    $("#btn-show-trash-education").addClass("bg-gradient-danger");
    $("#data_education").hide();
    $("#data_trash_education").show();
    $(".tombol-tambah").hide();
    // hapus warna btn
    $("#btn-show-education").removeClass("bg-gradient-primary");
});

// HANDLE TAMPIL DATA
$("body").on("click", "#btn-show-education", function () {
    $("#btn-show-education").addClass("bg-gradient-primary");
    $("#data_education").show();
    $("#data_trash_education").hide();
    $(".tombol-tambah").show();
    // hapus warna btn
    $("#btn-show-trash-education").removeClass("bg-gradient-danger");
});
...
$("body").on("click", ".tombol-edit", function () {
    ...
    // #2 Tampilkan Data
    $.ajax({
        url: API_URL + "/api/v1/ipedia/education-type/" + id,
        type: "GET",
...
$("body").on("click", ".tombol-restore", function (e) {
    ...
    $.ajax({
        url: API_URL + "/api/v1/ipedia/education-type/restore",
        type: "POST",
        dataType: "json",
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url:
                    API_URL +
                    "/api/v1/ipedia/education-type/force-delete/" +
                    id,
                type: "DELETE",
                success: function (response) {
                    Swal.fire(
...
function simpan(id = "") {
    ...
    if (id == "") {
        var_url = API_URL + "/api/v1/ipedia/education-type";
        type_url = "POST";
        ...
        var_url = API_URL + "/api/v1/ipedia/education-type/" + id;
        type_url = "PUT";
